...
const AboutUs = () => {
  ...
  const team = [
    { name: "Jeremiah Prince", role: "Founder & CEO", bio: "Visionary behind OptiLux. Passionate about merging luxury with accessibility in the eyewear space.", initials: "JP" },
    { name: "Amina Wanjiku",   role: "Head of Design",     bio: "Brings 10+ years of fashion design expertise to every frame we curate and stock.",              initials: "AW" },
    { name: "Brian Otieno",    role: "Operations Manager",  bio: "Ensures every order from Nairobi to Mombasa reaches you on time, every time.",                  initials: "BO" },
  ];
    ...
    <div className="about-page">
      ...
      <section className="about-story">
        <div className="about-story-inner">
          <div className="about-story-text">
            ...
            <p>Founded in 2026, OptiLux started as a small boutique in Diani with a simple belief — that the right pair of glasses can transform not just how you see the world, but how the world sees you.</p>
            <p>Today we serve thousands of customers across Kenya, offering over 320 premium frames from 40+ certified brands, all delivered to your doorstep with the care and speed you deserve.</p>
            <p>We are not just selling eyewear. We are building confidence, one frame at a time.</p>
          </div>
          <div className="about-story-stats">
            <div className="about-stat"><h3>5,200+</h3><p>Happy Customers</p></div>
            <div className="about-stat"><h3>320+</h3><p>Premium Frames</p></div>
            <div className="about-stat"><h3>40+</h3><p>Certified Brands</p></div>
      ...
      <section className="about-cta">
        <div className="about-cta-inner">
          ...
          <button onClick={() => navigate("/products")} className="about-cta-btn">Shop the Collection</button>
        </div>
      </section>
