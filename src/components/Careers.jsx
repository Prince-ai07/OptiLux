  ...
  const jobs = [
    {
      ...
      responsibilities: [
        "Build and maintain React-based web interfaces",
        "Collaborate with the design team to implement pixel-perfect UI",
        "Optimise application performance and loading speeds",
        "Integrate REST APIs from our Flask backend",
      ...
      requirements: [
        ...
        "Eye for detail and passion for clean UI",
    ...
    },
    {
      ...
      responsibilities: [
        "Drive sales of OptiLux products across assigned territories",
        "Build and maintain relationships with opticians and retail partners",
        "Conduct product demonstrations and consultations",
        "Meet and exceed monthly sales targets",
        "Provide market feedback to the product team"
      ],
      requirements: [
        "1+ years of sales experience",
        "Excellent communication and interpersonal skills",
        "Self-motivated with a results-driven attitude",
        "Knowledge of the Kenyan retail landscape",
    ...
    },
    {
      ...
      responsibilities: [
        "Coordinate daily delivery schedules across coastal Kenya",
        "Manage relationships with courier and logistics partners",
        "Track and resolve delivery issues in real time",
        "Maintain inventory accuracy at the Mombasa warehouse",
        "Report on delivery KPIs to the operations manager"
      ],
      requirements: [
    ...
    },
    {
      ...
      type: "Full-time",
      level: "Mid-level",
      description: "We are looking for a creative and detail-oriented UI/UX Designer to shape the visual identity and user experience of OptiLux across web and mobile. You will work closely with our tech and marketing teams to create experiences that feel as premium as our products.",
      responsibilities: [
        "Design elegant, intuitive interfaces for web and mobile",
        "Create wireframes, prototypes, and high-fidelity mockups",
        "Conduct user research and usability testing",
        "Maintain and evolve the OptiLux design system",
        "Collaborate with developers to ensure faithful implementation"
      ],
      requirements: [
        "3+ years of UI/UX design experience",
        "Proficiency in Figma or Adobe XD",
        "Strong portfolio demonstrating clean, modern design",
        "Understanding of accessibility and responsive design principles",
        "Experience designing for e-commerce is a strong advantage"
      ]
    },
    {
      id: 5,
      ...
      responsibilities: [
        "Design and maintain Flask REST APIs",
        "Optimise MySQL database queries and schema",
        "Implement secure payment integrations including M-Pesa",
        "Build internal admin tools for the operations team",
        "Ensure API security, reliability, and uptime"
      ],
      requirements: [
        "3+ years of backend development experience",
        "Strong proficiency in Python and Flask",
        "Deep knowledge of MySQL and database optimisation",
    ...
    },
    {
      ...
      type: "Full-time",
      level: "Mid-level",
      description: "OptiLux is building one of Kenya's most recognisable luxury brands. We need a creative Brand and Content Strategist to lead our storytelling across all channels — from social media to email campaigns to the OptiLux Journal.",
      responsibilities: [
        "Develop and execute OptiLux's content strategy",
        "Write compelling blog articles, product descriptions, and social copy",
        "Manage the OptiLux social media presence",
        "Collaborate with the design team on visual campaigns",
        "Track content performance and optimise based on data"
      ],
      requirements: [
        "3+ years in content strategy or brand marketing",
        "Exceptional writing and storytelling skills",
        "Deep understanding of luxury brand aesthetics",
        "Experience with social media management tools",
        "Passion for fashion, eyewear, or lifestyle brands"
      ]
    },
  ];
    ...
    <div className="careers-page">
      ...
      <nav className="about-nav">
        ...
        <div className="about-nav-links">
          ...
          <span className="about-nav-link active">Careers</span>
        </div>
      ...
      <section className="careers-hero">
        <div className="careers-hero-content">
          ...
          <p className="careers-hero-sub">
            We are a passionate team on a mission to make premium eyewear
            accessible across Kenya. If you are driven, creative, and ready
            to make an impact — we want to hear from you.
          </p>
        ...
        <div className="careers-jobs-inner">
          ...
          <div className="careers-filters">
            {filters.map((f, i) => (
              <button
                key={i}
                className={`careers-filter-btn ${activeFilter === f ? "active" : ""}`}
              ...
              <div key={job.id} className="careers-job-item">
                ...
                {activeJob === job.id && (
                  <div className="careers-job-details">
                    ...
                    <button
                      className="careers-apply-full-btn"
